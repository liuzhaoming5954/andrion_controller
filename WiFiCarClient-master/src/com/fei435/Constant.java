...
public class Constant {
	...
	//µÚÒ»´Î°²×°Ó¦ÓÃ³ÌÐòºó£¬»¹Ã»ÓÐÆô¶¯¹ý£¬Ã»ÓÐ´´½¨sharedPreference
	//ÕâÐ©Öµ¾ÍÊÇ sharedPreferenceµÄÄ¬ÈÏÖµ
	//TODO:ÏîÄ¿Íê³Éºó¸ü¸ÄÕâÐ©Öµ
    ...
    public final static int CONNECTION_TIMEOUT_INT = 3*1000;  //httpÁ¬½Ó³¬Ê±Ê±¼ä
    public final static int SO_TIMEOUT_INT = 3*1000;		  //httpµÈ´ýdataÊ±¼ä
    ...
    //Õâ¸öµÄÖµÊÇÒ»´ò¿ªapp¾ÍÒª·¢ËÍµÄ³õÊ¼ËÙ¶È·Ö±ðÊÇ506  16
